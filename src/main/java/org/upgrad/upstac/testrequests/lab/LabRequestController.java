...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        try {
            new_user= userLoggedInService.getLoggedInUser();
            return testRequestQueryService.findByTester(new_user);
        }
        catch(AppException exception){
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST,exception.getMessage()); // replace this line with your code
        }
